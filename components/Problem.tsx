...
// For instance:
// - Hero: "NXT SaaS helps developers launch startups fast"
// - Problem Agitation: "Developers spend too much time adding features, get overwhelmed, and quit." (not about NXT SaaS at all)
// - Features: "NXT SaaS has user auth, Stripe, emails all set up for you"
const Problem = () => {
  return (
